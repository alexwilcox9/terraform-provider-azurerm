...
func (r DnsDSRecordResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			id := recordsets.NewRecordTypeID(subscriptionId, model.ResourceGroupName, model.ZoneName, recordsets.RecordTypeDS, model.Name)
			...
			parameters := recordsets.RecordSet{
				...
				Properties: &recordsets.RecordSetProperties{
					...
					DSRecords: expandAzureRmDnsDSRecords(model.Record),
				},
			}
	...
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if metadata.ResourceData.HasChange("record") {
				payload.Properties.DSRecords = expandAzureRmDnsDSRecords(model.Record)
			}
...
func flattenAzureRmDnsDSRecords(records *[]recordsets.DsRecord) []DnsDSRecordResourceRecord {
...
func expandAzureRmDnsDSRecords(d []DnsDSRecordResourceRecord) *[]recordsets.DsRecord {
