...
func resourceSentinelDataConnectorThreatIntelligenceRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	modelTI, ok := model.(dataconnectors.TIDataConnector)
	if !ok {
		return fmt.Errorf("%s was not a Threat Intelligence Data Connector", id)
	}

	d.Set("name", modelTI.Name)
	d.Set("log_analytics_workspace_id", workspaceId.ID())
	d.Set("tenant_id", modelTI.Properties.TenantId)
	d.Set("lookback_date", modelTI.Properties.TipLookbackPeriod)
